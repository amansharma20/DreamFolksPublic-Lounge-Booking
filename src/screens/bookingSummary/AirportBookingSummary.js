...
export default function AirportBookingSummary() {
        ...
        <ScrollView style={styles.container}>
            <View style={styles.innerContainer}>
                ...
                <View style={styles.personalFullContainer}>
                    <View style={styles.personalDetailsContainerLeft}>
                    ...
                    <View style={styles.personalDetailsContainerRight}>
                        <Text style={styles.personalDetailsText}>
                            Naman Rathi
                        </Text>
                        <Text style={styles.personalDetailsText}>
                    ...
                    <View style={styles.addressContainer}>
                        <View style={styles.bookedContainer}>
                            ...
                            <View style={styles.memberContainer}>
                                <Image source={icons.carSeatIcon}
                                    style={styles.seatIconSize}
                                />
                        ...
                        <View style={styles.boxAndTextInnerContainer}>
...
const styles = StyleSheet.create({
    ...
    personalDetailsContainerLeft: {
        width: '33%',
    },

    personalDetailsContainerRight: {
        width: '67%'
    },

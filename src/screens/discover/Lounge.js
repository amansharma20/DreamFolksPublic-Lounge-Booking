...
import LoungeItems from '../../components/flatlistItems/discoverItems/LoungeItems';
...
<ScrollView showsVerticalScrollIndicator={false}>
      ...
      {icons.j==1?
      <View>
    <View style={{ borderTopLeftRadius: 14,marginTop:20, borderTopRightRadius: 14 }}>
      
        <View style={styles.bestServiceFlatlistContainer}>
          <View style={styles.bestServiceTextContainer}>
            <Text style={[styles.bestServiceText, { color: COLORS.brownText }]}>
              Purchase membership
            </Text>
          </View>
          <FlatList
